...
JEPSEN_TESTS_PARAMETERS=(
  ...
  "--workload register --nemesis kill-erlang-vm --time-limit 120 --concurrency 10 --rate 40 --ops-per-key 10 --time-before-disruption 5 --disruption-duration 20 --erlang-net-ticktime 6 --release-cursor-every 10 --wal-max-size-bytes 524288 --random-nodes 2"
